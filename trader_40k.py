...
class Trader:
    ...
    def __init__(self):
        ...
        self.last_days = 100
        self.banana_days = 2
        self.mean_days = {"PINA_COLADAS": 1, "COCONUTS": 1, "DIVING_GEAR": 1, "PICNIC_BASKET": 1}
        ...
        self.mean_diffs = {"BANANAS": [], "PEARLS": [], "PINA_COLADAS": [], "COCONUTS": [], "DIVING_GEAR": [], "BERRIES": [], "PICNIC_BASKET": []}
